...
```bash
gonna get added, wait a minute or somethin
```
...
<N/C...> | These 2 symbols create loops, determined by a number or cell at the beginning. [1] gets the cell 1, and 1 makes it loop once. e.g. <1+++>\, <[0]+++>\
